                ...
                style={
                    {
                        background: imagePreview ?
                            `url("${imagePreview}") no-repeat center/cover` : null
                    }}>
